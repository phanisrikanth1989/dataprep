...
4. **ENG-JR-003 (P1)**: Implement die_on_error config toggle
5. **ENG-JR-004/005 (P1)**: Implement reverse context/globalMap sync
6. **PERF-JR-002/003 (P1)**: Add chunked processing for large DataFrames

### Long-term (Optimization)

7. **ENG-JR-012 (P3)**: Add tStatCatcher statistics support
8. **PERF-JR-006 (P3)**: Add JIT warmup for frequently executed code
