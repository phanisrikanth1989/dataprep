...
2. **ENG-FT-001** (P1): Align engine config key `create_directory` with converter `createdir` or vice versa
3. Add `_validate_config()` implementation to check for required `filename`

### Long-term (Optimization)
4. **TEST-FT-001** (P2): Add engine unit tests for FileTouch
5. **ENG-FT-002** (P2): Add die_on_error support
6. **STD-FT-001** (P2): Replace f-strings in logger calls with % formatting
7. **PERF-FT-001** (P3): Minor -- no action needed
