...
1. Enter Job Details Modal
   ↓

1. Click "Create"
   ↓

1. Redirected to Job Designer
   ↓
...
1. Job saved to jobs/{job_id}.json
   ↓

1. Click "Execute" to run the job (optional)
   ↓

1. Monitor execution in Execution Monitor
```
