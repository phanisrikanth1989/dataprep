...
Issues and specs for this repo live as markdown files in `.scratch/`. Not GitHub Issues —
the repo has a GitHub remote, but Issues there are unused and skills must not write to them.
...
`.scratch/` is **not** gitignored — issue files are tracked and committed like any other
source file. Existing precedent in this repo: `.scratch/etl-studio/{research,issues}/`.
