...
Vendored verbatim from agents/tools/surface_code_cells.py (ticket 16; map
invariant: never import from agents/). The conductor's pre-execution code
gate calls ``surface_code_cells(job_config)`` on the assembled job.
