...
Vendored verbatim from agents/tools/audit_log.py (ticket 16; map invariant:
never import from agents/). The bus wraps it -- see core/bus.py.
"""
...
def main(argv=None) -> int:
    ...
    if args.detail:
        ...
        if not isinstance(detail, dict):
            sys.stderr.write("--detail must be a JSON object\n")
            return 2
