"""PaginationSorted component - pagination with a configurable ASCENDING sort.
...
@REGISTRY.register("PaginationSorted", "tPaginationSorted")
class PaginationSorted(BaseComponent):
