            ...
            "components": [
                {
                    ...
                    "outputs": ["row1"],
                    "schema": {"input": [], "output": [
                        {"name": "order_id", "type": "int", "nullable": False, "key": False},
                        {"name": "customer_id", "type": "int", "nullable": False, "key": False},
                        {"name": "amount", "type": "float", "nullable": False, "key": False},
                        {"name": "product", "type": "str", "nullable": False, "key": False},
                    ]},
                    "subjob_id": "subjob_1",
                ...
                },
                {
                    ...
                    "schema": {"input": [], "output": [
                        {"name": "customer_id", "type": "int", "nullable": False, "key": False},
                        {"name": "customer_name", "type": "str", "nullable": False, "key": False},
                        {"name": "region", "type": "str", "nullable": False, "key": False},
                    ]},
                    "subjob_id": "subjob_1",
                ...
                },
                {
                    ...
                    "schema": {"input": [], "output": [
                        {"name": "order_id", "type": "int", "nullable": False, "key": False},
                        {"name": "customer_name", "type": "str", "nullable": True, "key": False},
                        {"name": "amount", "type": "float", "nullable": False, "key": False},
                        {"name": "product", "type": "str", "nullable": False, "key": False},
                        {"name": "region", "type": "str", "nullable": True, "key": False},
                    ]},
                    "subjob_id": "subjob_1",
                    "is_subjob_start": False,
                },
